...
model Guideline36MPCHeating
  ...
  extends
    ControlComparison.Testbeds.VAVReheat.BaseClasses.ZoneAirTemperatureDeviation(
      banDevSum(each uppThreshold=293.65, each lowThreshold=292.65));
  ...
  Modelica.Blocks.Math.Add sitEneTotInt
    annotation (Placement(transformation(extent={{1360,566},{1380,586}})));
equation
  ...
  connect(booRepSupFan.y, banDevSum.uSupFan) annotation (Line(points={{522,640},
          ...
          255,0,255}));
  connect(eleTotInt.y, sitEneTotInt.u1) annotation (Line(points={{1341,612},{
          1350,612},{1350,582},{1358,582}}, color={0,0,127}));
  connect(gasTotInt.y, sitEneTotInt.u2) annotation (Line(points={{1341,544},{
          1350,544},{1350,570},{1358,570}}, color={0,0,127}));
  annotation (
