within ControlComparison.Testbeds.VAVReheat.BaseClasses;
...
//    annotation (Placement(transformation(extent={{118,-36},{98,-56}})));
  ...
  ControlComparison.Testbeds.VAVReheat.ThermalZones.VAVBranch cor(
  ...
  ControlComparison.Testbeds.VAVReheat.ThermalZones.VAVBranch sou(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  ControlComparison.Testbeds.VAVReheat.ThermalZones.VAVBranch eas(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  ControlComparison.Testbeds.VAVReheat.ThermalZones.VAVBranch nor(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  ControlComparison.Testbeds.VAVReheat.ThermalZones.VAVBranch wes(
    redeclare package MediumA = MediumA,
    redeclare package MediumW = MediumW,
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate VSupWes_flow(
    ...
    allowFlowReversal=allowFlowReversal) "Discharge air flow rate" annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={1300,128})));
  ControlComparison.Testbeds.VAVReheat.BaseClasses.MixingBox eco(
    redeclare package Medium = MediumA,
