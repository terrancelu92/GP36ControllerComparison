...
model ModeSelector "Finite State Machine for the operational modes"
  ...
  State unOccOff(
    mode=ControlComparison.Testbeds.VAVReheat.Controls.OperationModes.unoccupiedOff,
    nIn=3,
    nOut=4) "Unoccupied off mode, no coil protection"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  State unOccNigSetBac(
    nOut=2,
    mode=ControlComparison.Testbeds.VAVReheat.Controls.OperationModes.unoccupiedNightSetBack,
  ...
  State morWarUp(mode=ControlComparison.Testbeds.VAVReheat.Controls.OperationModes.unoccupiedWarmUp,
                                                                            nIn=2,
  ...
  State occ(       mode=ControlComparison.Testbeds.VAVReheat.Controls.OperationModes.occupied,
                                                                      nIn=3)
    "Occupied mode"
  ...
  State morPreCoo(
    nIn=1,
    mode=ControlComparison.Testbeds.VAVReheat.Controls.OperationModes.unoccupiedPreCool,
