within ControlComparison.Testbeds.VAVReheat.Controls;
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch swi4
    "If the MPC is activated, the supply air temperature will not be reset"
    annotation (Placement(transformation(extent={{30,-30},{50,-10}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant supTemSetOcc(k=
        TSupSetOcc) "Fixed supply temperature setpoint under the MPC mode"
...
equation
  ...
  connect(swi4.y, swi2.u3) annotation (Line(points={{52,-20},{56,-20},{56,-34},{
          10,-34},{10,-68},{18,-68}}, color={0,0,127}));
  connect(BooMPCFla.y, swi4.u2)
    annotation (Line(points={{-19,-20},{28,-20}}, color={255,0,255}));
  connect(supTemSetOcc.y, swi4.u1) annotation (Line(points={{-48,-40},{4,-40},{4,
          -12},{28,-12}}, color={0,0,127}));
  connect(lin.y, swi4.u3) annotation (Line(points={{42,50},{48,50},{48,10},{20,10},
